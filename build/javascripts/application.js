...
var ClassicalComponent = function (_React$Component) {
  _inherits(ClassicalComponent, _React$Component);

  function ClassicalComponent(props) {
    _classCallCheck(this, ClassicalComponent);

    // ...because, constructors! :P

    // Set initial state.
    var _this = _possibleConstructorReturn(this, (ClassicalComponent.__proto__ || Object.getPrototypeOf(ClassicalComponent)).call(this, props));
    ...
    _this.customFunc = _this.customFunc.bind(_this);
    return _this;
  }

  _createClass(ClassicalComponent, [{
